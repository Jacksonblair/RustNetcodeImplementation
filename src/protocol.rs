...
pub fn calculate_crc32(buffer: &[u8], length: u32, crc_32: u32) -> u32 {
    let mut _crc_32 = (crc_32 as u64 + crc_32 as u64 ^ 0xFFFFFFFF) as u32;
    for i in 0..length {
        _crc_32 =
            (_crc_32 >> 8) ^ CRC32_TABLE[((_crc_32 ^ (buffer[i as usize] as u32)) & 0xFF) as usize];
    }
    return _crc_32 ^ 0xFFFFFFFF;
}
